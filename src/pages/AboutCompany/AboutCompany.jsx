...
export default function AboutCompany() {
  ...
  <div className="about-container">
    <h2 className="about-title">{translations.o_nas}</h2>

    <div className="about-intro">
      <p>
        {translations.we_parnter}
        <br />
        {translations.our_company}
      </p>
    </div>
    ...
    <div className="about-photos">
      ...
      <div className="about-photo-gallery">
        <img src={warehouse1} alt="Склад 1" className="grid-image art-gallery-img" />
        <img src={warehouse2} alt="Склад 2" className="grid-image art-gallery-img" />
        <img src={warehouse3} alt="Склад 3" className="grid-image art-gallery-img" />
      </div>
    </div>
