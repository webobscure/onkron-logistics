...
import "./Header.css";
import {Box, Container, Grid, Link, Paper, Tab, Tabs, Toolbar, Typography} from "@mui/material";
...
const Header = () => {
    ...
    return (
        <>
            <Paper elevation={4} sx={{boxShadow: " 0px 2px 10px rgba(0, 0, 0, 0.05)"}}>
                <Link sx={{
                    minHeight: "64px",
                    textAlign: "center",
                    ...
                    <Typography variant="h6" sx={{letterSpacing: "0.0075em"}}>
                        Lorem impisum
                    </Typography>
                </Link>
                <Box sx={{borderBottom: "1px solid rgba(220, 228, 241, 0.5)"}}>
                    <Container maxWidth="1200" sx={{paddingLeft: 3, paddingRight: 3}}>
                        <Toolbar variant="regular" sx={{minHeight: "64px"}}>
                            <Grid container sx={{
                                ...
                                <Grid item sx={{paddingLeft: 3}}>
                                    <Link href="/">
                                        <img src={logo} style={{maxWidth: "139px", maxHeight: "44px"}}/>
                                    </Link>
                                </Grid>
                                <Grid container item sx={{paddingLeft: 3, justifyContent: "space-between", width: "88%"}}>
                                    <Grid container sx={{justifyContent: "flex-end", alignItems: "center"}}>
                                        <Grid item sx={{paddingLeft: 1}}>
                                            <Link href="mailto:order@onkron.de" underline="none" sx={{
                                                color: "rgb(36, 45, 57)",
                                                fontSize: "0.875rem"
                                            }}>order@onkron.de</Link>
                                        </Grid>
                                        <Grid item sx={{paddingLeft: 1}}>
                                            <Link href="tel:494029996807" underline="none" sx={{
                                                color: "#000",
                                                fontWeight: 550,
                                                marginRight: "16px"
                                            }}>+494029996807</Link>
                ...
                <nav className="nav">
                    <div className="container">
                        ...
                        <div className="nav-right">
                            ...
                            <Link href="tel: +494029996807" style={{
                                width: "40px",
                                height: "40px",
                                borderRadius: "14px",
                            ...
                            <Link href="https://api.whatsapp.com/send?phone=494029996807" style={{
                                width: "40px",
                                height: "40px",
                                borderRadius: "14px",
                                border: "1px solid #e31e24",
