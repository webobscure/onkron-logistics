...
const FaqSection = () => {
  ...
  const initialQuestions = [
    ...
    },
    {
      ...
      answer: `In our warehouse you can store anything that is not prohibited by the legislation of Germany and is not included in the list from the question “What can't be stored in the warehouse?”.`,
    },
    {
...
Any items and property stolen or prohibited for circulation on the territory of Germany`,
    },
    {
      question: 'I need to move furniture into storage - do you do that?',
      answer:
        "Yes, we will provide delivery, as well as movers, if necessary. We will disassemble, pack, carefully load, deliver to the warehouse, place and provide a photo report. You don't even have to be present",
    },
    {
