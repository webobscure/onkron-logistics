...
const FaqSection = () => {
  ...
  const initialQuestions = [
    {
      question: "Как снять склад в Санкт-Петербурге?",
      answer:
        "Снять склад в аренду можно по цене от 1250 рублей за 1 м² - на выбор теплые и холодные боксы разной площади. Забронировать бокс по телефону 8 (964) 377-55-19 или оставить заявку на сайте. По желанию проведем онлайн-экскурсию.",
    },
    {
